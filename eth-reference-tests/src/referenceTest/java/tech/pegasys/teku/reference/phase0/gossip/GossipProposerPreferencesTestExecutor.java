...
public class GossipProposerPreferencesTestExecutor implements TestExecutor {
  ...
  public void runTest(final TestDefinition testDefinition) throws Throwable {
    ...
    // Pyspec generates these fixtures with the Gloas spec module and inserts setup blocks and
    // post-states directly into its store. Use an always-Gloas spec to recreate that fixture chain,
    // while retaining the configured spec below for production gossip validation.
